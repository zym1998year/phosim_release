...
void test_readText() {
    ...
    for (size_t t(0); t < pars.getSize(); t++) {
        ...
        readText::get(line, "my_integer", mInteger);
        readText::get(line, "my_long", mLong);
        readText::get(line, "my_float", mFloat);
        readText::get(line, "my_double", mDouble);
    }
    ...
    unitTestOutput(mDouble, 3.14, "readText::get", "Get parameter", "none");
