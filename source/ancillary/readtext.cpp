...
/// @{
/// @addtogroup readtext_group readText
/// @{


readText::readText(std::istream & inStream) {
    /// @fn readText::readText(std::istream & inStream)
    /// @brief Read text from stream

    readStream(inStream);
}

readText::readText(const std::string & txtFile) {
    /// @fn readText::readText(const std::string & txtFile)
    /// @brief Read text from text file
...
void readText::readStream(std::istream & inStream) {
    /// @fn readText::readStream(std::istream & inStream)
    /// @brief Read stream from stream
...
bool readText::goodLine(std::string & line) {
    /// @fn bool readText::goodLine(std::string & line)
    /// @brief Determine if line is good
...
std::istream& readText::getLine(std::istream & inStream, std::string & line) {
    /// @fn std::istream& readText::getLine(std::istream & inStream, std::string & line)
    /// @brief Get line
...
void readText::readCol(const std::string & txtFile, std::vector<double> & col1, std::vector<double> & col2) {
    /// @fn void readText::readCol(const std::string & txtFile, std::vector<double> & col1, std::vector<double> & col2)
    /// @brief read column
...
void readText::readCol(const std::string & txtFile, std::vector<double> & col1, std::vector<double> & col2, std::vector<double> & col3) {
    /// @fn void readText::readCol(const std::string & txtFile, std::vector<double> & col1, std::vector<double> & col2)
    /// @brief read column
...
void readText::readColArr(const std::string & txtFile, double* & col1, double* & col2) {
    /// @fn void readText::readColArr(const std::string & txtFile, double* & col1, double* & col2)
    /// @brief Read a column array
...
void readText::readMultiCol(const std::string & txtFile, std::vector<double> & col1, std::vector<std::vector<double> > & col2) {
    /// @fn void readText::readMultiCol(const std::string & txtFile, std::vector<double> & col1, std::vector<std::vector<double> > & col2)
    /// @brief Read multiple columns of vector class doubles
...
void readText::readMultiColArr(const std::string & txtFile, double* & col1, double** & col2) {
    /// @fn void readText::readMultiColArr(const std::string & txtFile, double* & col1, double** & col2)
    /// @brief Read multiple column array of type double
...
void readText::readSegmentation(const std::string & txtFile, const std::string & key, std::vector<std::string> & value) {
    /// @fn void readText::readSegmentation(const std::string & txtFile, const std::string & key, std::vector<std::string> & value)
    /// @brief Read segmentation structured file
