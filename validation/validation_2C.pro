...
pro validation_2C,nnn,vers,value,tolerance_low,tolerance_high,task,name,unit,comparison
  ...
  for ii=0L,29 do begin
     ...
     if ii ge 12 and ii le 17 then begin
        tname='throughput_lsst_e_222'+string(filter,format='(I1)')+'_f'+string(filter,format='(I1)')+'_R22_S11_E00'
        cc=130 & lc=1
     endif
     if ii ge 18 and ii le 23 then begin
        tname='throughput_lsst_e_223'+string(filter,format='(I1)')+'_f'+string(filter,format='(I1)')+'_R22_S11_E00'
        cc=100 & lc=1
     endif
     if ii ge 24 and ii le 29 then begin
        tname='throughput_lsst_e_224'+string(filter,format='(I1)')+'_f'+string(filter,format='(I1)')+'_R22_S11_E00'
        cc=180 & lc=1
     endif
     tname1=tname+'0.txt'
     tname2=tname+'1.txt'
     ...
     oplot,a(good)/1000.0+0.3,(c(good)/b(good)*100.0-yint)*err,color=20,psym=3
  ...
  for ii=0L,29 do begin
     ...
     yint=interpol(y,x,a(good)/1000.0+0.3)
     oplot,a(good)/1000.0+0.3,(f(good)/c(good)*100.0-yint)*err,color=20,psym=3
  endfor
  ...
  for ii=0L,29 do begin
     ...
     yint=interpol(y,x,a(good)/1000.0+0.3)
     oplot,a(good)/1000.0+0.3,(j(good)/f(good)*100.0-yint)*err,color=20,psym=3
  endfor
  ...
  for ii=0L,29 do begin
     ...
     oplot,a(good)/1000.0+0.3,(l(good)/j(good)*100.0-yint)*err,color=20,psym=3
  endfor
  ...
  for ii=0L,29 do begin
     ...
     yint=interpol(y,x,a(good)/1000.0+0.3)
     oplot,a(good)/1000.0+0.3,(n(good)/l(good)*100.0-yint)*err,color=20,psym=3
  endfor
  ...
  for ii=0L,29 do begin
     ...
     yint=interpol(y,x,a(good)/1000.0+0.3)
     oplot,a(good)/1000.0+0.3,(o(good)/n(good)*100.0-yint)*err,color=20,psym=3
  endfor
...
;xyouts,0.1,0.32,ss,/normal
  ...
  for ii=0L,29 do begin
     ...
     if filter eq 4 then yint=interpol(y4,x4,a(good)/1000.0+0.3)
     if filter eq 5 then yint=interpol(y5,x5,a(good)/1000.0+0.3)
     oplot,a(good)/1000.0+0.3,(o(good)/c(good)*100.0-yint)*err,color=20,psym=3
