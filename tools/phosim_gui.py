...
#    Dec 02, 2019 04:14:56 PM EST  platform: Linux
...
class PhoSim_gui:
    def __init__(self, top=None):
        ...
        self.StarsCheckButton.configure(takefocus="0")
        ...
        self.Label22.place(relx=0.06, rely=0.86, height=19, width=136)
        ...
        self.NoBckGrdCheckButton.place(relx=0.3, rely=0.85, relheight=0.07
                , relwidth=0.18)
        ...
        self.QuickBckGrdCheckButton.place(relx=0.49, rely=0.85, relheight=0.07
                , relwidth=0.19)
        ...
        self.QuickBckGrdCheckButton.configure(state=ACTIVE)
        ...
        self.NormalBckGrdCheckButton.place(relx=0.7, rely=0.85, relheight=0.07
                , relwidth=0.21)
        ...
        self.NormalBckGrdCheckButton.configure(state=ACTIVE)
        ...
        self.CatalogCenterLabel = Label(self.UniverseFrame)
        self.CatalogCenterLabel.place(relx=0.13, rely=0.73, height=19, width=137)

        self.CatalogCenterLabel.configure(activebackground="#f9f9f9")
        self.CatalogCenterLabel.configure(anchor=E)
        self.CatalogCenterLabel.configure(background="#ffffff")
        self.CatalogCenterLabel.configure(justify=RIGHT)
        self.CatalogCenterLabel.configure(text='''Catalog Center:''')

        self.CatalogRightAscensionLabel = Label(self.UniverseFrame)
        self.CatalogRightAscensionLabel.place(relx=0.35, rely=0.73, height=19
                , width=113)
        self.CatalogRightAscensionLabel.configure(activebackground="#f9f9f9")
        self.CatalogRightAscensionLabel.configure(anchor=E)
        self.CatalogRightAscensionLabel.configure(background="#ffffff")
        self.CatalogRightAscensionLabel.configure(justify=RIGHT)
        self.CatalogRightAscensionLabel.configure(text='''Right Ascension:''')
        self.CatalogRightAscensionLabel.configure(width=113)

        self.CatalogRAEntryDeg = Entry(self.UniverseFrame)
        self.CatalogRAEntryDeg.place(relx=0.5, rely=0.73, height=26
                , relwidth=0.12)
        self.CatalogRAEntryDeg.configure(background="white")
        self.CatalogRAEntryDeg.configure(justify=RIGHT)
        self.CatalogRAEntryDeg.configure(selectbackground="#c4c4c4")
        self.CatalogRAEntryDeg.configure(textvariable=phosim_gui_support.CatalogRADeg)
        self.CatalogRAEntryDeg.bind('<FocusIn>',lambda e:phosim_gui_support.FocusIn(phosim_gui_support.CatalogRADeg))
        self.CatalogRAEntryDeg.bind('<FocusOut>',lambda e:phosim_gui_support.FocusOut(phosim_gui_support.CatalogRAEntryGood, phosim_gui_support.CatalogRADeg))
        self.CatalogRAEntryDeg.bind('<KeyRelease>',lambda e:phosim_gui_support.RADecCatalogEntryChange())

        self.CatalogDeclinationLabel = Label(self.UniverseFrame)
        self.CatalogDeclinationLabel.place(relx=0.68, rely=0.73, height=19
                , width=83)
        self.CatalogDeclinationLabel.configure(activebackground="#f9f9f9")
        self.CatalogDeclinationLabel.configure(anchor=E)
        self.CatalogDeclinationLabel.configure(background="#ffffff")
        self.CatalogDeclinationLabel.configure(justify=RIGHT)
        self.CatalogDeclinationLabel.configure(text='''Declination:''')
        self.CatalogDeclinationLabel.configure(width=83)

        self.CatRaDegLabel = Label(self.UniverseFrame)
        self.CatRaDegLabel.place(relx=0.63, rely=0.73, height=19, width=27)
        self.CatRaDegLabel.configure(activebackground="#f9f9f9")
        self.CatRaDegLabel.configure(anchor=W)
        self.CatRaDegLabel.configure(background="#ffffff")
        self.CatRaDegLabel.configure(text='''deg''')

        self.CatalogDecEntryDeg = Entry(self.UniverseFrame)
        self.CatalogDecEntryDeg.place(relx=0.8, rely=0.73, height=26
                , relwidth=0.12)
        self.CatalogDecEntryDeg.configure(background="white")
        self.CatalogDecEntryDeg.configure(justify=RIGHT)
        self.CatalogDecEntryDeg.configure(selectbackground="#c4c4c4")
        self.CatalogDecEntryDeg.configure(textvariable=phosim_gui_support.CatalogDecDeg)
        self.CatalogDecEntryDeg.configure(width=96)
        self.CatalogDecEntryDeg.bind('<FocusIn>',lambda e:phosim_gui_support.FocusIn(phosim_gui_support.CatalogDecDeg))
        self.CatalogDecEntryDeg.bind('<FocusOut>',lambda e:phosim_gui_support.FocusOut(phosim_gui_support.CatalogDecEntryGood, phosim_gui_support.CatalogDecDeg))
        self.CatalogDecEntryDeg.bind('<KeyRelease>',lambda e:phosim_gui_support.DecDegCatalogEntryChange())

        self.CatDecDegLabel = Label(self.UniverseFrame)
        self.CatDecDegLabel.place(relx=0.93, rely=0.73, height=19, width=28)
        self.CatDecDegLabel.configure(activebackground="#f9f9f9")
        self.CatDecDegLabel.configure(anchor=W)
        self.CatDecDegLabel.configure(background="#ffffff")
        self.CatDecDegLabel.configure(text='''deg''')
        ...
        self.MontLabel.place(relx=0.08, rely=0.07, height=18, width=70)
        self.MontLabel.configure(activebackground="#f9f9f9")
        self.MontLabel.configure(anchor=E)
        ...
        self.SkyLabel.place(relx=0.1, rely=0.22, height=21, width=50)
        self.SkyLabel.configure(activebackground="#f9f9f9")
        self.SkyLabel.configure(anchor=E)
        ...
        self.DateLabel.configure(anchor=E)
        ...
        self.PhysicsFrame.place(relx=0.04, rely=0.07, relheight=1.0
                , relwidth=1.0)
        ...
        self.ExistingCommandFileLabel.place(relx=-0.02, rely=0.73, height=21
                , width=175)
        ...
        self.ExistCmdFileNameEntry.place(relx=0.01, rely=0.8, height=33
                , relwidth=0.6)
        ...
        self.AtmosphereFrame = Frame(self.PhysicsFrame)
        self.AtmosphereFrame.place(relx=0.28, rely=0.03, relheight=0.54
                , relwidth=0.34)
        self.AtmosphereFrame.configure(relief=GROOVE)
        self.AtmosphereFrame.configure(borderwidth="2")
        self.AtmosphereFrame.configure(relief=GROOVE)
        self.AtmosphereFrame.configure(background="#ffffff")
        self.AtmosphereFrame.configure(width=265)

        self.AtmLabel = Label(self.AtmosphereFrame)
        self.AtmLabel.place(relx=0.04, rely=0.12, height=19, width=89)
        self.AtmLabel.configure(activebackground="#f9f9f9")
        self.AtmLabel.configure(background="#ffffff")
        self.AtmLabel.configure(text='''Atmosphere:''')

        self.AtmosphereOnCheckButton = Checkbutton(self.AtmosphereFrame)
        self.AtmosphereOnCheckButton.place(relx=0.38, rely=0.06, relheight=0.15
                , relwidth=0.18)
        self.AtmosphereOnCheckButton.configure(activebackground="#ffffff")
        self.AtmosphereOnCheckButton.configure(anchor=W)
        self.AtmosphereOnCheckButton.configure(background="#ffffff")
        self.AtmosphereOnCheckButton.configure(highlightthickness="0")
        self.AtmosphereOnCheckButton.configure(state=ACTIVE)
        self.AtmosphereOnCheckButton.configure(text='''On''')
        self.AtmosphereOnCheckButton.configure(variable=phosim_gui_support.AtmosphereONON)
        self.AtmosphereOnCheckButton.bind('<ButtonRelease-1>',lambda e:phosim_gui_support.SetAtmosphereModeCheckButtons("On"))

        self.AtmospherePupilDiffOnlyCheckButton = Checkbutton(self.AtmosphereFrame)
        self.AtmospherePupilDiffOnlyCheckButton.place(relx=0.38, rely=0.18
                , relheight=0.15, relwidth=0.59)
        self.AtmospherePupilDiffOnlyCheckButton.configure(activebackground="#ffffff")
        self.AtmospherePupilDiffOnlyCheckButton.configure(anchor=W)
        self.AtmospherePupilDiffOnlyCheckButton.configure(background="#ffffff")
        self.AtmospherePupilDiffOnlyCheckButton.configure(highlightthickness="0")
        self.AtmospherePupilDiffOnlyCheckButton.configure(state=ACTIVE)
        self.AtmospherePupilDiffOnlyCheckButton.configure(text='''Pupil Diffraction Only''')
        self.AtmospherePupilDiffOnlyCheckButton.configure(variable=phosim_gui_support.AtmospherrPupilDiffOnlyOn)
        self.AtmospherePupilDiffOnlyCheckButton.bind('<ButtonRelease-1>',lambda e:phosim_gui_support.SetAtmosphereModeCheckButtons("PupilDiffractionOnly"))

        self.AtmosphereOffCheckButton = Checkbutton(self.AtmosphereFrame)
        self.AtmosphereOffCheckButton.place(relx=0.64, rely=0.06, relheight=0.15
                , relwidth=0.18)
        self.AtmosphereOffCheckButton.configure(activebackground="#ffffff")
        self.AtmosphereOffCheckButton.configure(anchor=W)
        self.AtmosphereOffCheckButton.configure(background="#ffffff")
        self.AtmosphereOffCheckButton.configure(highlightthickness="0")
        self.AtmosphereOffCheckButton.configure(state=ACTIVE)
        self.AtmosphereOffCheckButton.configure(text='''Off''')
        self.AtmosphereOffCheckButton.configure(variable=phosim_gui_support.AtmosphereOffOn)
        self.AtmosphereOffCheckButton.bind('<ButtonRelease-1>',lambda e:phosim_gui_support.SetAtmosphereModeCheckButtons("Off"))

        self.AtmDispersionOnButton = Checkbutton(self.AtmosphereFrame)
        self.AtmDispersionOnButton.place(relx=0.08, rely=0.3, relheight=0.15
                , relwidth=0.67)
        self.AtmDispersionOnButton.configure(activebackground="#ffffff")
        self.AtmDispersionOnButton.configure(anchor=W)
        self.AtmDispersionOnButton.configure(background="#ffffff")
        self.AtmDispersionOnButton.configure(highlightthickness="0")
        self.AtmDispersionOnButton.configure(state=ACTIVE)
        self.AtmDispersionOnButton.configure(text='''Atmospheric Dispersion''')
        self.AtmDispersionOnButton.configure(variable=phosim_gui_support.AtmDispersionOn)

        self.AtmClearOpacityOnButton = Checkbutton(self.AtmosphereFrame)
        self.AtmClearOpacityOnButton.place(relx=0.08, rely=0.42, relheight=0.15
                , relwidth=0.48)
        self.AtmClearOpacityOnButton.configure(activebackground="#ffffff")
        self.AtmClearOpacityOnButton.configure(anchor=W)
        self.AtmClearOpacityOnButton.configure(background="#ffffff")
        self.AtmClearOpacityOnButton.configure(highlightthickness="0")
        self.AtmClearOpacityOnButton.configure(state=ACTIVE)
        self.AtmClearOpacityOnButton.configure(text='''Clear Opacity''')
        self.AtmClearOpacityOnButton.configure(variable=phosim_gui_support.ClearOpacityOn)
        self.AtmClearOpacityOnButton.configure(width=127)

        self.AtmClearCloudsOnButton = Checkbutton(self.AtmosphereFrame)
        self.AtmClearCloudsOnButton.place(relx=0.08, rely=0.55, relheight=0.15
                , relwidth=0.44)
        self.AtmClearCloudsOnButton.configure(activebackground="#ffffff")
        self.AtmClearCloudsOnButton.configure(anchor=W)
        self.AtmClearCloudsOnButton.configure(background="#ffffff")
        self.AtmClearCloudsOnButton.configure(highlightthickness="0")
        self.AtmClearCloudsOnButton.configure(state=ACTIVE)
        self.AtmClearCloudsOnButton.configure(text='''Clear Clouds''')
        self.AtmClearCloudsOnButton.configure(variable=phosim_gui_support.ClearCloudsOn)
        self.AtmClearCloudsOnButton.configure(width=117)

        self.AtmClearTurbulanceOnButton = Checkbutton(self.AtmosphereFrame)
        self.AtmClearTurbulanceOnButton.place(relx=0.08, rely=0.67
                , relheight=0.15, relwidth=0.55)
        self.AtmClearTurbulanceOnButton.configure(activebackground="#ffffff")
        self.AtmClearTurbulanceOnButton.configure(anchor=W)
        self.AtmClearTurbulanceOnButton.configure(background="#ffffff")
        self.AtmClearTurbulanceOnButton.configure(highlightthickness="0")
        self.AtmClearTurbulanceOnButton.configure(state=ACTIVE)
        self.AtmClearTurbulanceOnButton.configure(text='''Clear Turbulence''')
        self.AtmClearTurbulanceOnButton.configure(variable=phosim_gui_support.ClearTurbulenceOn)
        self.AtmClearTurbulanceOnButton.configure(width=147)

        self.WindshakeOnButton = Checkbutton(self.AtmosphereFrame)
        self.WindshakeOnButton.place(relx=0.08, rely=0.79, relheight=0.15
                , relwidth=0.37)
        self.WindshakeOnButton.configure(activebackground="#ffffff")
        self.WindshakeOnButton.configure(anchor=W)
        self.WindshakeOnButton.configure(background="#ffffff")
        self.WindshakeOnButton.configure(highlightthickness="0")
        self.WindshakeOnButton.configure(state=ACTIVE)
        self.WindshakeOnButton.configure(text='''Windshake''')
        self.WindshakeOnButton.configure(variable=phosim_gui_support.WindshakeOn)

        self.Frame4 = Frame(self.PhysicsFrame)
        self.Frame4.place(relx=0.63, rely=0.03, relheight=0.87, relwidth=0.32)
        self.Frame4.configure(relief=GROOVE)
        self.Frame4.configure(borderwidth="2")
        self.Frame4.configure(relief=GROOVE)
        self.Frame4.configure(background="#ffffff")
        self.Frame4.configure(width=245)

        self.OptCntrlTelModeLabel = Label(self.Frame4)
        self.OptCntrlTelModeLabel.place(relx=0.04, rely=0.08, height=19
                , width=79)
        self.OptCntrlTelModeLabel.configure(activebackground="#f9f9f9")
        self.OptCntrlTelModeLabel.configure(background="#ffffff")
        self.OptCntrlTelModeLabel.configure(text='''Telescope :''')

        self.TelModeNormalButton = Checkbutton(self.Frame4)
        self.TelModeNormalButton.place(relx=0.37, rely=0.08, relheight=0.09
                , relwidth=0.31)
        self.TelModeNormalButton.configure(activebackground="#ffffff")
        self.TelModeNormalButton.configure(anchor=W)
        self.TelModeNormalButton.configure(background="#ffffff")
        self.TelModeNormalButton.configure(highlightthickness="0")
        self.TelModeNormalButton.configure(state=ACTIVE)
        self.TelModeNormalButton.configure(text='''Normal''')
        self.TelModeNormalButton.configure(variable=phosim_gui_support.TelNormalOn)
        self.TelModeNormalButton.configure(width=77)
        self.TelModeNormalButton.bind('<ButtonRelease-1>',lambda e:phosim_gui_support.SetTelescopeModeCheckButtons("Normal"))

        self.TelModePerfectButton = Checkbutton(self.Frame4)
        self.TelModePerfectButton.place(relx=0.65, rely=0.08, relheight=0.09
                , relwidth=0.27)
        self.TelModePerfectButton.configure(activebackground="#ffffff")
        self.TelModePerfectButton.configure(anchor=W)
        self.TelModePerfectButton.configure(background="#ffffff")
        self.TelModePerfectButton.configure(highlightthickness="0")
        self.TelModePerfectButton.configure(state=ACTIVE)
        self.TelModePerfectButton.configure(text='''Perfect''')
        self.TelModePerfectButton.configure(variable=phosim_gui_support.TelPerfectOn)
        self.TelModePerfectButton.configure(width=67)
        self.TelModePerfectButton.bind('<ButtonRelease-1>',lambda e:phosim_gui_support.SetTelescopeModeCheckButtons("Perfect"))

        self.OptCntrlPerturbationModeLabel = Label(self.Frame4)
        self.OptCntrlPerturbationModeLabel.place(relx=0.04, rely=0.19, height=19
                , width=99)
        self.OptCntrlPerturbationModeLabel.configure(activebackground="#f9f9f9")
        self.OptCntrlPerturbationModeLabel.configure(background="#ffffff")
        self.OptCntrlPerturbationModeLabel.configure(text='''Perturbations:''')

        self.PerturbationControlSystemButton = Checkbutton(self.Frame4)
        self.PerturbationControlSystemButton.place(relx=0.04, rely=0.26
                , relheight=0.09, relwidth=0.52)
        self.PerturbationControlSystemButton.configure(activebackground="#ffffff")
        self.PerturbationControlSystemButton.configure(anchor=W)
        self.PerturbationControlSystemButton.configure(background="#ffffff")
        self.PerturbationControlSystemButton.configure(highlightthickness="0")
        self.PerturbationControlSystemButton.configure(state=ACTIVE)
        self.PerturbationControlSystemButton.configure(text='''Control System''')
        self.PerturbationControlSystemButton.configure(variable=phosim_gui_support.ControlSysOn)
        self.PerturbationControlSystemButton.configure(width=127)

        self.PerturbationEnviFabButton = Checkbutton(self.Frame4)
        self.PerturbationEnviFabButton.place(relx=0.04, rely=0.34, relheight=0.09
                , relwidth=0.93)
        self.PerturbationEnviFabButton.configure(activebackground="#ffffff")
        self.PerturbationEnviFabButton.configure(anchor=W)
        self.PerturbationEnviFabButton.configure(background="#ffffff")
        self.PerturbationEnviFabButton.configure(highlightthickness="0")
        self.PerturbationEnviFabButton.configure(state=ACTIVE)
        self.PerturbationEnviFabButton.configure(text='''Environmental/Fabrication Errors''')
        self.PerturbationEnviFabButton.configure(variable=phosim_gui_support.EnvFabErrorsOn)

        self.DiffractionLabel = Label(self.Frame4)
        self.DiffractionLabel.place(relx=0.04, rely=0.45, height=19, width=79)
        self.DiffractionLabel.configure(activebackground="#f9f9f9")
        self.DiffractionLabel.configure(background="#ffffff")
        self.DiffractionLabel.configure(text='''Diffraction:''')

        self.DiffractMCButton = Checkbutton(self.Frame4)
        self.DiffractMCButton.place(relx=0.33, rely=0.53, relheight=0.09
                , relwidth=0.4)
        self.DiffractMCButton.configure(activebackground="#ffffff")
        self.DiffractMCButton.configure(anchor=W)
        self.DiffractMCButton.configure(background="#ffffff")
        self.DiffractMCButton.configure(highlightthickness="0")
        self.DiffractMCButton.configure(state=ACTIVE)
        self.DiffractMCButton.configure(text='''Monte Carlo''')
        self.DiffractMCButton.configure(variable=phosim_gui_support.DiffractMCOn)
        self.DiffractMCButton.bind('<ButtonRelease-1>',lambda e:phosim_gui_support.SetDiffractionModeCheckButtons("MonteCarlo"))

        self.DiffractFFTButton = Checkbutton(self.Frame4)
        self.DiffractFFTButton.place(relx=0.73, rely=0.53, relheight=0.09
                , relwidth=0.23)
        self.DiffractFFTButton.configure(activebackground="#ffffff")
        self.DiffractFFTButton.configure(anchor=W)
        self.DiffractFFTButton.configure(background="#ffffff")
        self.DiffractFFTButton.configure(highlightthickness="0")
        self.DiffractFFTButton.configure(state=ACTIVE)
        self.DiffractFFTButton.configure(text='''FFT''')
        self.DiffractFFTButton.configure(variable=phosim_gui_support.DiffractFFTOn)
        self.DiffractFFTButton.bind('<ButtonRelease-1>',lambda e:phosim_gui_support.SetDiffractionModeCheckButtons("FFT"))

        self.CoatingsButton = Checkbutton(self.Frame4)
        self.CoatingsButton.place(relx=0.04, rely=0.72, relheight=0.09
                , relwidth=0.52)
        self.CoatingsButton.configure(activebackground="#ffffff")
        self.CoatingsButton.configure(anchor=W)
        self.CoatingsButton.configure(background="#ffffff")
        self.CoatingsButton.configure(highlightthickness="0")
        self.CoatingsButton.configure(state=ACTIVE)
        self.CoatingsButton.configure(text='''Optics Coatings''')
        self.CoatingsButton.configure(variable=phosim_gui_support.OpticsCoatingsOn)

        self.ConatminationsButton = Checkbutton(self.Frame4)
        self.ConatminationsButton.place(relx=0.04, rely=0.79, relheight=0.09
                , relwidth=0.72)
        self.ConatminationsButton.configure(activebackground="#ffffff")
        self.ConatminationsButton.configure(anchor=W)
        self.ConatminationsButton.configure(background="#ffffff")
        self.ConatminationsButton.configure(highlightthickness="0")
        self.ConatminationsButton.configure(state=ACTIVE)
        self.ConatminationsButton.configure(text='''Optics Contaminations''')
        self.ConatminationsButton.configure(variable=phosim_gui_support.ContaminationsOn)

        self.TrackingOnButton = Checkbutton(self.Frame4)
        self.TrackingOnButton.place(relx=0.04, rely=0.87, relheight=0.09
                , relwidth=0.36)
        self.TrackingOnButton.configure(activebackground="#ffffff")
        self.TrackingOnButton.configure(anchor=W)
        self.TrackingOnButton.configure(background="#ffffff")
        self.TrackingOnButton.configure(highlightthickness="0")
        self.TrackingOnButton.configure(state=ACTIVE)
        self.TrackingOnButton.configure(text='''Tracking''')
        self.TrackingOnButton.configure(variable=phosim_gui_support.TrackingOn)

        self.OpticsOnlyButton = Checkbutton(self.Frame4)
        self.OpticsOnlyButton.place(relx=0.04, rely=0.64, relheight=0.09
                , relwidth=0.93)
        self.OpticsOnlyButton.configure(activebackground="#ffffff")
        self.OpticsOnlyButton.configure(anchor=W)
        self.OpticsOnlyButton.configure(background="#ffffff")
        self.OpticsOnlyButton.configure(highlightthickness="0")
        self.OpticsOnlyButton.configure(state=ACTIVE)
        self.OpticsOnlyButton.configure(text='''Optics Only (No Atm/Detector)''')
        self.OpticsOnlyButton.configure(variable=phosim_gui_support.OpticsOnlyOn)
        self.OpticsOnlyButton.configure(width=227)

        self.DiffractOffOnButton = Checkbutton(self.Frame4)
        self.DiffractOffOnButton.place(relx=0.12, rely=0.53, relheight=0.09
                , relwidth=0.23)
        self.DiffractOffOnButton.configure(activebackground="#ffffff")
        self.DiffractOffOnButton.configure(anchor=W)
        self.DiffractOffOnButton.configure(background="#ffffff")
        self.DiffractOffOnButton.configure(highlightthickness="0")
        self.DiffractOffOnButton.configure(state=ACTIVE)
        self.DiffractOffOnButton.configure(text='''Off''')
        self.DiffractOffOnButton.configure(variable=phosim_gui_support.DiffractOffOn)
        self.DiffractOffOnButton.configure(width=57)
        self.DiffractOffOnButton.bind('<ButtonRelease-1>',lambda e:phosim_gui_support.SetDiffractionModeCheckButtons("Off"))

        self.Frame5 = Frame(self.PhysicsFrame)
        self.Frame5.place(relx=0.01, rely=0.03, relheight=0.67, relwidth=0.26)
        self.Frame5.configure(relief=GROOVE)
        self.Frame5.configure(borderwidth="2")
        self.Frame5.configure(relief=GROOVE)
        self.Frame5.configure(background="#ffffff")
        self.Frame5.configure(width=205)

        self.DetectorLabel = Label(self.Frame5)
        self.DetectorLabel.place(relx=0.24, rely=0.05, height=19, width=89)
        self.DetectorLabel.configure(activebackground="#f9f9f9")
        self.DetectorLabel.configure(background="#ffffff")
        self.DetectorLabel.configure(text='''Detector''')

        self.ChargeDiffusionButton = Checkbutton(self.Frame5)
        self.ChargeDiffusionButton.place(relx=0.05, rely=0.15, relheight=0.12
                , relwidth=0.62)
        self.ChargeDiffusionButton.configure(activebackground="#ffffff")
        self.ChargeDiffusionButton.configure(anchor=NW)
        self.ChargeDiffusionButton.configure(background="#ffffff")
        self.ChargeDiffusionButton.configure(highlightthickness="0")
        self.ChargeDiffusionButton.configure(text='''Charge Diffusion''')
        self.ChargeDiffusionButton.configure(variable=phosim_gui_support.ChargeDiffusionOn)

        self.ChargeSharingButton = Checkbutton(self.Frame5)
        self.ChargeSharingButton.place(relx=0.05, rely=0.24, relheight=0.12
                , relwidth=0.62)
        self.ChargeSharingButton.configure(activebackground="#ffffff")
        self.ChargeSharingButton.configure(anchor=W)
        self.ChargeSharingButton.configure(background="#ffffff")
        self.ChargeSharingButton.configure(highlightthickness="0")
        self.ChargeSharingButton.configure(text='''Charge Sharing''')
        self.ChargeSharingButton.configure(variable=phosim_gui_support.ChargeSharingOn)

        self.PixelErrorsButton = Checkbutton(self.Frame5)
        self.PixelErrorsButton.place(relx=0.05, rely=0.34, relheight=0.12
                , relwidth=0.47)
        self.PixelErrorsButton.configure(activebackground="#ffffff")
        self.PixelErrorsButton.configure(anchor=W)
        self.PixelErrorsButton.configure(background="#ffffff")
        self.PixelErrorsButton.configure(highlightthickness="0")
        self.PixelErrorsButton.configure(text='''Pixel errors''')
        self.PixelErrorsButton.configure(variable=phosim_gui_support.PixelErrorOn)

        self.FringingButton = Checkbutton(self.Frame5)
        self.FringingButton.place(relx=0.05, rely=0.44, relheight=0.12
                , relwidth=0.38)
        self.FringingButton.configure(activebackground="#ffffff")
        self.FringingButton.configure(anchor=W)
        self.FringingButton.configure(background="#ffffff")
        self.FringingButton.configure(highlightthickness="0")
        self.FringingButton.configure(text='''Fringing''')
        self.FringingButton.configure(variable=phosim_gui_support.FringingOn)

        self.FieldAnisotropyButton = Checkbutton(self.Frame5)
        self.FieldAnisotropyButton.place(relx=0.05, rely=0.54, relheight=0.12
                , relwidth=0.62)
        self.FieldAnisotropyButton.configure(activebackground="#ffffff")
        self.FieldAnisotropyButton.configure(anchor=W)
        self.FieldAnisotropyButton.configure(background="#ffffff")
        self.FieldAnisotropyButton.configure(highlightthickness="0")
        self.FieldAnisotropyButton.configure(text='''Field Anisotropy''')
        self.FieldAnisotropyButton.configure(variable=phosim_gui_support.FieldAnisotropyOn)

        self.ImpurityVariationButton = Checkbutton(self.Frame5)
        self.ImpurityVariationButton.place(relx=0.05, rely=0.63, relheight=0.12
                , relwidth=0.91)
        self.ImpurityVariationButton.configure(activebackground="#ffffff")
        self.ImpurityVariationButton.configure(anchor=W)
        self.ImpurityVariationButton.configure(background="#ffffff")
        self.ImpurityVariationButton.configure(highlightthickness="0")
        self.ImpurityVariationButton.configure(text='''Dopant Impurity Variation''')
        self.ImpurityVariationButton.configure(variable=phosim_gui_support.DopantImpurityVariationOn)

        self.SaturationButton = Checkbutton(self.Frame5)
        self.SaturationButton.place(relx=0.05, rely=0.73, relheight=0.12
                , relwidth=0.47)
        self.SaturationButton.configure(activebackground="#ffffff")
        self.SaturationButton.configure(anchor=W)
        self.SaturationButton.configure(background="#ffffff")
        self.SaturationButton.configure(highlightthickness="0")
        self.SaturationButton.configure(text='''Saturation''')
        self.SaturationButton.configure(variable=phosim_gui_support.SaturationOn)

        self.BloomingButton = Checkbutton(self.Frame5)
        self.BloomingButton.place(relx=0.05, rely=0.83, relheight=0.12
                , relwidth=0.47)
        self.BloomingButton.configure(activebackground="#ffffff")
        self.BloomingButton.configure(anchor=W)
        self.BloomingButton.configure(background="#ffffff")
        self.BloomingButton.configure(highlightthickness="0")
        self.BloomingButton.configure(text='''Blooming''')
        self.BloomingButton.configure(variable=phosim_gui_support.BloomingOn)
